...
//            MA: Disasteriscare se il modello deve rimanere lo stesso di quello dell'asset di partenza.            
//            if (data[i].isModel == true) {
...
//             MA: Disasteriscare se il modello deve rimanere lo stesso di quello dell'asset di partenza. 
//          }      else {
//                 data[i].action += '<button class="cam-table-button" ng-click="openNewAssetPanel(\'' + data[i].model + '\')' + '"> <i                     data-toggle="tooltip" title="Create new asset from this model" class="fa fa-plus cam-table-button"></i></div>                           </button>';
//            }
        }

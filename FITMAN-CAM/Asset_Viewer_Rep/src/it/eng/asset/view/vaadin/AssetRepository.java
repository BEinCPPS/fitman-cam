...
public class AssetRepository extends VerticalLayout implements View {
	...
	private void initEditor() {
			...
			Button addClassBt = new Button("New Model");
			addClassBt = createAssetModelButton(name_class);
			editorLayout.addComponent(addClassBt);
			editorLayout.setComponentAlignment(addClassBt, Alignment.BOTTOM_LEFT);
	}
	...
	private void initRightPanel() {
		...
		nameC.setValue("Instances of Class: "+name_class);
		...
		Label lb_filter = new Label("Filter by Model: ");
	...
	private void initClassGridtable(String ClassSelected, String opt_model) {
		...
		List<Asset> lAss = new ArrayList<Asset>();
		 ...
		 classGrid.setColumnWidth(name,130);
		 classGrid.setColumnWidth(classT,60);
		 classGrid.setColumnWidth(model,158);
		 classGrid.setColumnWidth(owner,50);
		 classGrid.setColumnWidth(created,70);
		 classGrid.setColumnWidth(actionDel,40);
		 classGrid.setColumnWidth(view,40);
		 //classGrid.setColumnWidth(aas,27);
		 classGrid.setColumnWidth(newAsset,40);
		...
		deleteButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				MessageBox.showPlain(Icon.QUESTION, 
				        "Delete "+asset_name, 
				        "Do you really want to delete the "+ asset_name+" class?", 
				        ...
				        addComponent(new HorizontalLayout() {
...

							{
				                ...
				                ok.addClickListener(new ClickListener() {
									...
									public void buttonClick(ClickEvent event) {
										if (owner_selected!= null && owner_selected.trim().length()==0)
											owner_selected=null;
   ...
   Button deleteOwnerDetailButton(final String name_owner) {
	...
	deleteButton.addClickListener(new ClickListener() {
		...
		public void buttonClick(ClickEvent event) {
			...
			MessageBox.showPlain(Icon.QUESTION, 
			        "Delete " +name_owner, 
			        "Do you want to delete "+name_owner+" from owners?", 
			        new de.steinwedel.messagebox.MessageBoxListener() {

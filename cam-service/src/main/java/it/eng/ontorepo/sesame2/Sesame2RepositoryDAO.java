...
public class Sesame2RepositoryDAO implements RepositoryDAO {
	 ...
	 *             if the Repository cannot be accessed, or the Reference
	 *             Ontology cannot be read for any reason
	 * @throws IllegalStateException
	 *             if the Reference Ontology declares no default namespace
	 */
	 ...
	 *            the name of the Repository
	 * @param namespace
	 *            the namespace to be used as the implicit namespace, or null if
	 ...
	 *             Ontology cannot be read for any reason
	 * @throws IllegalStateException
	 *             if no namespace argument was provided, and the Reference
	 ...
	 *
	 * @param (Optional)
	 *            dataDir is the directory where to save the memory store files.
	 * @param namespace
	 *            the namespace to be used as the implicit namespace, or null if
	 *            the default namespace declared in the Reference Ontology
	 *            should be used as the implicit namespace
	 ...
	 *
	 * @param rdfFile
	 *            The file xml RDF containing Ontology
	 * @param (optional)
	 *            The Base URI where to contain the definitions in file (ex.
	 *            http://example.org/example/local)
	 * @param forceAdd
	 *            Add file RDF content also if the repo in not empty
